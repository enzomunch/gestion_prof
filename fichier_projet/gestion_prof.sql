...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 24 avr. 2025 à 11:45
...
CREATE TABLE IF NOT EXISTS `classes` (
  ...
  `nomClasse` varchar(15) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `connexion` (
  ...
  `login` varchar(30) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `mdp` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `connexion` (`numConnexion`, `login`, `mdp`) VALUES
(1, 'admin', 'root');
...
CREATE TABLE IF NOT EXISTS `entreprises` (
  ...
  `nomEntreprise` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `telEntreprise` varchar(14) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `mailEntreprise` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `adresseEntreprise` varchar(150) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `matières` (
  ...
  `nomMat` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`numMat`)
...
CREATE TABLE IF NOT EXISTS `professeurs` (
  ...
  `nomProf` varchar(30) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `prenomProf` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `mailProf` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tuteurs` (
  ...
  `nomTuteur` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `prenomTuteur` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `telTuteur` varchar(14) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `mailTuteur` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
